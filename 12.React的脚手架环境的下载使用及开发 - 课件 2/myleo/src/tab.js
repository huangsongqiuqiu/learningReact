...
class Tab extends Component{
	...
	autoPlay(){
		...
		clearInterval(this.state.setTimeout)
		...
		this.state.setTimeout = setInterval(()=>{
			this.setState({
	...
	render(){
		...
		return (<div className='tab' onMouseOver={this.mouseOver.bind(this)} onMouseOut={this.mouseOut.bind(this)}>
